  ...
  return (
    <footer>
      ...
      <div id="footer-content">
        <div id="name_logo_footer">natakulyk</div>

        <div id="social_links_footer">
          <a
            href="https://github.com/Kulya1986/"
            rel="noreferrer"
            target="_blank"
            aria-label="Git Hub page - Kulya1986"
          >
          ...
          <a
            ...
            rel="noreferrer"
            target="_blank"
            aria-label="Frontend Mentor page - Kulya1986"
          >
          ...
          <a
            href="https://www.linkedin.com/in/nataliia-kulyk-7305a5240/"
            rel="noreferrer"
            target="_blank"
            aria-label="Linkedin page - Kulya1986"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="24">
              <path
                fill="#f8f3ef"
          ...
          <a
            href="https://www.facebook.com/natalya.kulik.7"
            rel="noreferrer"
            target="_blank"
            aria-label="Facebook page - natalya.kulik.7"
          >
      ...
      <div id="legacy">
        <a target="_blank" href="https://icons8.com/icon/118466/facebook">
          Facebook
        </a>{" "}
        &{" "}
        <a target="_blank" href="https://icons8.com/icon/83205/ok">
          Tick
        </a>{" "}
        icon by{" "}
        ...
        <br />
        <span>Background for the project's cover taken from </span>
        <a href="https://www.vecteezy.com/free-vector/abstract-background">
          Abstract Background Vectors by Vecteezy
        </a>
      </div>
    </footer>
  );
